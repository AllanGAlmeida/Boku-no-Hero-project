...
OBJETIVO 1 - quando passar o mouse em cima do personagem temos que:
 ...
 OBJETIVO 2 - quando passar o mouse em cima do personagem, trocar a imagem e nome do personagem grando:

 - alterar a imamem do jogador 1
...
const idSelecionado = personagem.attributes.id.value;
    if(idSelecionado === 'All_For_One') return;
